<template>
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      <h3 class="title">Master NC Platform</h3>
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;">
          <router-link class="link-type" :to="'/login'">Sign in with an existing account</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          ...
          register(this.registerForm).then(res => {
            ...
            this.$alert("<font color='red'>Congratulations, your account " + username + " Registration succeeded!</font>", 'System prompt', {
